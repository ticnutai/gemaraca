...
חפש באתרים הבאים:
- פסקדין - אתר פסקי הדין הרבניים של בתי הדין הרבניים בישראל
- תורה בינט - ספריית שו"ת וספרי הלכה
- המכון לחקר המשפט העברי - אוניברסיטת בר אילן
- אתר 'דעת' - האקדמיה הלאומית הישראלית למדעים

חפש גם בספריית שו"ת ובספרי הלכה רלוונטיים.
...
3. שנה (אם ידועה)
4. מספר תיק (אם יש)
5. קישור ישיר למקור (חובה!)
6. תקציר של הפסק דין (2-3 משפטים)
7. הסבר על הקשר לסוגיה בגמרא

החזר תוצאות רק עם קישורים אמיתיים מאומתים. אל תמציא קישורים.
החזר עד 5 פסקי דין רלוונטיים ביותר.
    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "אתה עוזר מומחה בחיפוש פסקי דין רבניים ומקורות הלכתיים. תמיד ספק קישורים אמיתיים ומדויקים למקורות."
          },
          {
            role: "user",
